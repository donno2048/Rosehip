import os,sys,time;import importlib;sys.dont_write_bytecode=True;os.environ['PYGAME_HIDE_SUPPORT_PROMPT']='1';import pyautogui,keyboard,threading,pygame,pygame_gui;from pygame_gui.elements import UIPanel,UIButton;PANEL_LAYER = 10;BUTTON_DIMS = (200, 25);pygame.display.set_icon(pygame.image.load('image.jpg'))
class Menu(UIPanel):

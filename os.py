import os,sys,threading,keyboard,pygame_gui,importlib;sys.dont_write_bytecode=True;os.environ['PYGAME_HIDE_SUPPORT_PROMPT']='1';import pygame;from win32gui import GetWindowText, GetForegroundWindow;from pygame_gui.elements import UIPanel,UIButton;PANEL_LAYER = 10;BUTTON_DIMS = (200, 25);pygame.display.set_icon(pygame.image.load(os.path.join(os.path.dirname(__file__),'image.jpg')))
class Menu(UIPanel):
